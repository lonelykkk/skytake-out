...
-- ----------------------------
INSERT INTO `address_book` VALUES (2, 4, 'kkk', '0', '13970095229', '11', '北京市', '1101', '市辖区', '110102', '西城区', '江西农业大学', '3', 1);
...
CREATE TABLE `order_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '订单明细表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order_detail
-- ----------------------------
INSERT INTO `order_detail` VALUES (5, '鮰鱼2斤', 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/8cfcc576-4b66-4a09-ac68-ad5b273c2590.png', 4, 67, NULL, NULL, 1, 72.00);
INSERT INTO `order_detail` VALUES (6, '江团鱼2斤', 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/a101a1e9-8f8b-47b2-afa4-1abd47ea0a87.png', 4, 66, NULL, NULL, 1, 119.00);
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (4, '1711894651364', 1, 4, 2, '2024-03-31 22:17:31', NULL, 1, 5, 199.00, '', '13970095229', '江西农业大学', NULL, 'kkk', NULL, NULL, NULL, '2024-03-31 23:17:00', 0, NULL, 2, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '套餐' ROW_FORMAT = Dynamic;
...
CREATE TABLE `setmeal_dish`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '套餐菜品关系' ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (4, '0b3SqV000cD8RR1gBt000LcKGC0SqV0c', NULL, NULL, NULL, NULL, NULL, '2024-03-31 22:16:34');
